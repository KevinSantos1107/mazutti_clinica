...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const SPECIALTY_IMAGES = {
    'Cardiologista':                     'imagens/cardio.png',
    'Neurologista':                      'imagens/neuro.png',
    'Ortopedista / Traumatologista':     'imagens/orto.png',
    'Ginecologista':                     'imagens/gine.png',
    'Obstetra':                          'imagens/obstetra.png',
    'Pediatra':                          'imagens/pediatra.png',
    'Oftalmologista':                    'imagens/oftal.png',
    'Endocrinologista':                  'imagens/endo.png',
    'Gastroenterologista':               'imagens/gastro.png',
    'Otorrinolaringologista':            'imagens/otorrino.png',
    'Dermatologista':                    'imagens/derma.png',
    'Angiologista':                      'imagens/angio.png',
    'Urologista':                        'imagens/uro.png',
    'Geriatra':                          'imagens/geriatra.png',
    'Psicólogo':                         'imagens/psicologo.png',
    'Psiquiatra':                        'imagens/psiquiatra.png',
    'Nutricionista':                     'imagens/nutri.png',
    'Reumatologista':                    'imagens/reuma.png',
    'Médico da Família / Clínico Geral': 'imagens/clinico-geral.png',
    'Medicina do Esporte':               'imagens/medicina-esporte.png',
    'Médico da Família':                 'imagens/medico-familia.png',
  };
  ...
  /* ============================================================
     ...
     - Dots sincronizados com o slide ativo
     - Clique nos dots para navegação manual
  ============================================================ */
  const slides    = document.querySelectorAll('.hero-slide');
  const dots      = document.querySelectorAll('.hero-dot');
  const INTERVAL  = 5000; // milissegundos entre cada troca
  let   currentSlide = 0;
  ...
  // Função que avança para um slide específico
  ...
  // Clique nos dots — navegação manual
  dots.forEach((dot, i) => {
    dot.addEventListener('click', () => {
      goToSlide(i);
      startSlideshow(); // reinicia o timer após clique manual
    });
  });

  // Inicia o slideshow (sem pausa no hover)
  if (slides.length > 0) {
    startSlideshow();
  }

  console.log('✅ Mazutti Clínica Médica — scripts + GA4 + Lucide Icons + WA especialidades + Slideshow carregados com sucesso!');
});